      ...
      <div className="w-full md:w-1/2 lg:w-1/3 p-4">
        <div className="h-full bg-gray-100 rounded-2xl">
          <Image
            ...
            height={300}
            width={300}
            src={`${process.env.STRAPI_URL || "https://strapi-lh2y.onrender.com"}${imageUrl}`}
            alt=""
          />
        <div className="p-8">
          ...
          <div className="flex flex-wrap md:justify-center -m-2">
            <div className="w-full md:w-auto p-2 my-6">
              <Link
                className="block w-full px-12 py-3.5 text-lg text-center text-white font-bold bg-gradient-to-r from-indigo-500 from 20% via-sky-500 via 60% to-emerald-500 to-90% hover:bg-gradient-to-r from-indigo-600 from 20% via-sky-600 via 60% to-emerald-600 to-90% focus:ring-4 focus:ring-gray-600 rounded-full"
